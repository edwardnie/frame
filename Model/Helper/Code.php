...
class Helper_Code {
    ...
    public static function code( $width = 120, $height = 40, $fontSize = 18 ) {
        $code = new Code( array(
            'width' => $width,
            'height' => $height,
            'fontSize' => $fontSize,
            'font' => ROOT_DIR . 'Themes/font/font.ttf'
        ) );
        $code->show();
    }
}
...
class Code {
    ...
    //验证码
    public $code;
    //验证码的随机种子去掉1,i和l容易分不清
    public $codeStr = "23456789abcdefghjkmnpqrstuvwsyz";
    //验证码长度
    public $codeLen = 4;
    //验证码字体
    ...
    private function createCode() {
        ...
        $_SESSION ['auth_img_code'] = md5( strtolower( $this->code ) );
    }
